...
export class AuthRepository {
  ...
  createUser(nome: string, email: string, senhaHash: string, role: 'ADMIN' | 'PROFESSOR' | 'ALUNO') { return prisma.user.create({ data: { nome, email, senhaHash, role }, select: { id: true, nome: true, email: true, role: true } }); }
